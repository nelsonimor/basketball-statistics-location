package fr.basketball.statistics.location.domain.ddd;

import static fr.basketball.statistics.location.domain.ddd.DDD.Layer.APPLICATION;
import static fr.basketball.statistics.location.domain.ddd.DDD.Layer.DOMAIN;
import static fr.basketball.statistics.location.domain.ddd.DDD.Layer.INFRASTRUCTURE;
