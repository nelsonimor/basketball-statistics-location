package fr.bsm.location.domain.ddd;

import static fr.bsm.location.domain.ddd.DDD.Layer.APPLICATION;
import static fr.bsm.location.domain.ddd.DDD.Layer.DOMAIN;
import static fr.bsm.location.domain.ddd.DDD.Layer.INFRASTRUCTURE;
